...
CONFIG.PCW_FCLK0_PERIPHERAL_DIVISOR1 {1} CONFIG.PCW_FCLK1_PERIPHERAL_CLKSRC {DDR PLL} \
CONFIG.PCW_FCLK1_PERIPHERAL_DIVISOR0 {7} CONFIG.PCW_FCLK1_PERIPHERAL_DIVISOR1 {1} \
...
CONFIG.PCW_FPGA_FCLK2_ENABLE {1} CONFIG.PCW_FPGA_FCLK3_ENABLE {0} \
...
CONFIG.PCW_IMPORT_BOARD_PRESET {./lib/xml/ZYBO_zynq_def.xml} CONFIG.PCW_INCLUDE_ACP_TRANS_CHECK {0} \
CONFIG.PCW_INCLUDE_TRACE_BUFFER {0} CONFIG.PCW_IOPLL_CTRL_FBDIV {20} \
CONFIG.PCW_IO_IO_PLL_FREQMHZ {1000.000} CONFIG.PCW_IRQ_F2P_INTR {0} \
...
CONFIG.PCW_NOR_CS1_WE_TIME {2} CONFIG.PCW_NOR_GRP_A25_ENABLE {0} \
...
CONFIG.PCW_NOR_SRAM_CS1_WE_TIME {2} CONFIG.PCW_OVERRIDE_BASIC_CLOCK {0} \
...
CONFIG.PCW_P2F_USB1_INTR {0} CONFIG.PCW_PACKAGE_DDR_BOARD_DELAY0 {0.176} \
...
CONFIG.PCW_S_AXI_HP1_FREQMHZ {100} CONFIG.PCW_S_AXI_HP1_ID_WIDTH {6} \
...
CONFIG.PCW_UIPARAM_DDR_DRAM_WIDTH {16 Bits} CONFIG.PCW_UIPARAM_DDR_ECC {Disabled} \
...
CONFIG.PCW_UIPARAM_DDR_PARTNO {MT41K128M16 JT-125} CONFIG.PCW_UIPARAM_DDR_ROW_ADDR_COUNT {14} \
...
CONFIG.PCW_USB1_PERIPHERAL_ENABLE {0} CONFIG.PCW_USB1_PERIPHERAL_FREQMHZ {60} \
CONFIG.PCW_USB1_RESET_ENABLE {0} CONFIG.PCW_USB1_RESET_IO {<Select>} \
CONFIG.PCW_USB1_USB1_IO {<Select>} CONFIG.PCW_USB_RESET_ENABLE {0} \
CONFIG.PCW_USB_RESET_POLARITY {Active Low} CONFIG.PCW_USB_RESET_SELECT {<Select>} \
CONFIG.PCW_USE_AXI_FABRIC_IDLE {0} CONFIG.PCW_USE_CORESIGHT {0} \
...
CONFIG.PCW_USE_EXPANDED_PS_SLCR_REGISTERS {0} CONFIG.PCW_USE_FABRIC_INTERRUPT {0} \
...
CONFIG.PCW_WDT_PERIPHERAL_FREQMHZ {133.333333} CONFIG.PCW_WDT_WDT_IO {<Select>} \
  ...
  connect_bd_net -net rst_processing_system7_0_71M_peripheral_aresetn [get_bd_pins AXIinterfacefor65816_0/s00_axi_aresetn] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_71M/peripheral_aresetn]
