cmd_drivers/serial/serial_zynq.o := arm-xilinx-linux-gnueabi-gcc -Wp,-MD,drivers/serial/.serial_zynq.o.d  -nostdinc -isystem /opt/petalinux/petalinux-v2014.4-final/tools/linux-i386/arm-xilinx-linux-gnueabi/bin/../lib/gcc/arm-xilinx-linux-gnueabi/4.8.3/include -Iinclude  -I/home/steven/Desktop/LINUX_SNES/build/linux/u-boot/src/u-boot-plnx/include -I/home/steven/Desktop/LINUX_SNES/build/linux/u-boot/src/u-boot-plnx/arch/arm/include  -I/home/steven/Desktop/LINUX_SNES/build/linux/u-boot/src/u-boot-plnx/drivers/serial -Idrivers/serial -D__KERNEL__ -DCONFIG_SYS_TEXT_BASE=0x1fc00000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -g -fstack-usage -Wno-format-nonliteral -DCONFIG_ARM -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -march=armv7-a -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -fno-strict-aliasing -mno-unaligned-access -mfpu=neon -pipe    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(serial_zynq)"  -D"KBUILD_MODNAME=KBUILD_STR(serial_zynq)" -c -o drivers/serial/serial_zynq.o /home/steven/Desktop/LINUX_SNES/build/linux/u-boot/src/u-boot-plnx/drivers/serial/serial_zynq.c

source_drivers/serial/serial_zynq.o := /home/steven/Desktop/LINUX_SNES/build/linux/u-boot/src/u-boot-plnx/drivers/serial/serial_zynq.c

deps_drivers/serial/serial_zynq.o := \
    $(wildcard include/config/zynq/serial/baudrate0.h) \
    $(wildcard include/config/baudrate.h) \
    $(wildcard include/config/zynq/serial/baudrate1.h) \
...
drivers/serial/serial_zynq.o: $(deps_drivers/serial/serial_zynq.o)
